...
export const solutionsData = [
  {
    ...
    description: "Estruturas em alumínio com teto retrátil automatizado, criando ambientes versáteis para qualquer clima.",
  ...
  {
    id: 2,
    title: "Ombrelones Arquitetônicos",
    description: "Design imponente e durabilidade excepcional. Ideais para criar áreas de sombra com sofisticação.",
    image: "/assets/projetos/techlar-sol-ombrelones-hq.jpg",
    isAccent: false,
    anchor: "ombrelones",
  },
  {
  ...
  {
    id: 4,
    title: "Toldos Premium",
    description: "Soluções versáteis e elegantes em toldos, projetadas para oferecer o máximo de conforto em áreas externas.",
    image: "/assets/projetos/toldos/IMG-20240423-WA0065-hq.jpg",
    isAccent: false,
    anchor: "toldos",
  },
  {
